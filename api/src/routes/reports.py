...
async def list_views():
    ...
    return {
        "views": [
            {"id": "consumer", "name": "Consumer View", "description": "Simple, clear language"},
            {"id": "operator", "name": "Operator View", "description": "Technical details"},
            {"id": "analyst", "name": "Analyst View", "description": "Full data and metrics"},
            {"id": "audit", "name": "Audit View", "description": "Complete provenance trail"}
        ]
    }
...
async def export_report(
    report_id: str,
    format: ExportFormatType = ExportFormatType.json
):
    """
    ...
    """
    try:
        from datagod.ux import MultiViewReportGenerator, ExportFormat
...
async def generate_all_views(request: GenerateReportRequest):
    ...
    try:
        ...
        reports = generator.generate_all_views(
            data=request.data,
            title=request.title
        )
