...
class DataValidator:
    ...
    def _load_validation_rules(self) -> Dict[str, Dict]:
        ...
        return {
            ...
            'record': {
                ...
                'record_type_options': ['person', 'property', 'business', 'court', 'legal'],
                'data_format': 'json'
            }
        }
    
    def validate_jurisdiction(self, jurisdiction_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if 'state' in jurisdiction_data:
            ...
            if not re.match(self.validation_rules['jurisdiction']['state_pattern'], state):
        ...
        if 'name' in jurisdiction_data:
            ...
            if not re.match(self.validation_rules['jurisdiction']['name_pattern'], name):
    ...
    def validate_record(self, record_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if 'record_type' in record_data:
            ...
            if record_type not in self.validation_rules['record']['record_type_options']:
    ...
    def calculate_quality_metrics(self, data: Dict[str, Any], source: str) -> Dict[str, float]:
