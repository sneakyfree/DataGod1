...
class GuidedIntakeWizard:
            ...
            fields=[
                ...
                },
                {
                    ...
                    "options": [
                        ...
                        {
                            "value": "apartment",
                            "label": "Apartment Building (5+ units)",
                        },
                ...
                # Stage 3: Research Goals
                {
                    ...
                    "options": [
                        ...
                        {
                            "value": "title_search",
                            "label": "Title Search/Due Diligence",
                        },
    ...
    def start_session(
        self, schema_id: str, user_id: Optional[int] = None
    ) -> Dict[str, Any]:
        """
    ...
    def submit_stage(self, session_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        contradictions = self._detect_contradictions(
            schema, self._current_session["data"]
        )
        ...
        blocking_contradictions = [
            c for c in contradictions if c.severity == ValidationSeverity.ERROR
        ]
    ...
    def resolve_contradiction(
        self, session_id: str, contradiction_index: int, resolution: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        return {"resolved": True, "remaining_contradictions": len(contradictions)}
    ...
    def get_summary(self, session_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "complete": self._current_session["current_stage"]
            > len(self.SCHEMAS[self._current_session["schema_id"]].progressive_stages),
        }

    def _get_stage_fields(
        self, schema: IntakeSchema, stage: int
    ) -> List[Dict[str, Any]]:
    ...
    def _check_uncertain_responses(
        self, schema: IntakeSchema, data: Dict[str, Any]
    ) -> List[str]:
    ...
    def _generate_verification_tasks(
        self, schema: IntakeSchema, uncertain_fields: List[str]
