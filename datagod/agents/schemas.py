...
class AgentTask(BaseModel):
    ...
    assigned_agent: Optional[str] = Field(
        None, description="Which specialist agent should handle this"
    )
    subtasks: List[str] = Field(
        default_factory=list, description="IDs of decomposed subtasks"
    )
    ...
    deadline: Optional[datetime] = Field(
        None, description="Optional deadline for completion"
    )
...
class AgentOutput(BaseModel):
    ...
    result_type: str = Field(
        ...,
        description="Type of result: property_data, entity_match, risk_assessment, etc.",
    )
...
class AgentAction(BaseModel):
    ...
    # Action details
    action: str = Field(
        ..., description="Action type: query_database, call_api, calculate, etc."
    )
...
class ToolDefinition(BaseModel):
    ...
    allowed_agents: List[str] = Field(
        default_factory=list, description="Which agents can use this tool"
    )
