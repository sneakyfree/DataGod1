...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("datagod.log"), logging.StreamHandler(sys.stdout)],
)
...
def create_sample_jurisdiction():
    ...
    try:
        ...
        jurisdiction = (
            session.query(Jurisdiction).filter_by(name="Sample County").first()
        )
...
def create_sample_data_source():
    ...
    try:
        ...
        data_source = (
            ...
            .filter_by(source_name="Sample Property Source")
            .first()
        )
