...
class TaxRecordsScraper:
    ...
    def get_property_taxes(
        self, parcel_id: str, state: str, county: str, tax_year: int = None
    ) -> List[TaxRecord]:
        """
        ...
        logger.info(
            f"Getting property taxes for {parcel_id} in {county}, {state} ({year})"
        )
        records = []
    ...
    def get_delinquent_taxes(
        self, state: str, county: str, min_amount: float = 0
    ) -> List[TaxRecord]:
        """
    ...
    def get_tax_liens(
        self, state: str, county: str = "", parcel_id: str = "", owner_name: str = ""
    ) -> List[TaxRecord]:
        """
    ...
    def get_tax_sales(
        self, state: str, county: str = "", upcoming_only: bool = True
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_exemptions(
        self, state: str, county: str, exemption_type: str = ""
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_tax_history(
        self, parcel_id: str, state: str, county: str, years: int = 5
    ) -> List[TaxRecord]:
        """
...
def search_property_taxes(
    parcel_id: str, state: str, county: str, year: int = None
) -> List[Dict[str, Any]]:
