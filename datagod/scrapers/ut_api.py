"""
Utah State API Integration
Auto-generated scraper for Utah (UT) public records

Generated: 2025-12-31T17:18:20.839740
"""
...
COUNTY_APIS = {
    "salt_lake": {
        "name": "Salt Lake",
        "base_url": "https://slco.org/recorder/api",
    ...
    "utah": {
        "name": "Utah",
        "base_url": "https://www.utahcounty.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "davis": {
        "name": "Davis",
        "base_url": "https://www.daviscountyutah.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "weber": {
        "name": "Weber",
        "base_url": "https://www.webercountyutah.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "washington": {
        "name": "Washington",
        "base_url": "https://www.washco.utah.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "cache": {
        "name": "Cache",
        "base_url": "https://www.cachecounty.org/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class UtahAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Utah (UT) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Utah API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Utah API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Utah-specific API data to standard DataGod format.
...
def get_ut_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> UtahAPI:
    """
    Get a configured Utah API instance.
    ...
    Returns:
        Configured UtahAPI instance
    """
    return UtahAPI(jurisdiction_id, config)
