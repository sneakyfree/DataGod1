"""
Iowa State API Integration
Auto-generated scraper for Iowa (IA) public records

Generated: 2025-12-31T17:18:20.840971
"""
...
COUNTY_APIS = {
    "polk": {
        "name": "Polk",
        "base_url": "https://www.polkcountyiowa.gov/recorder/api",
    ...
    "linn": {
        "name": "Linn",
        "base_url": "https://www.linncountyiowa.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "scott": {
        "name": "Scott",
        "base_url": "https://www.scottcountyiowa.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "johnson": {
        "name": "Johnson",
        "base_url": "https://www.johnsoncountyiowa.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "black_hawk": {
        "name": "Black Hawk",
        "base_url": "https://www.blackhawkcounty.iowa.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "woodbury": {
        "name": "Woodbury",
        "base_url": "https://www.woodburycountyiowa.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class IowaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Iowa (IA) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Iowa API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Iowa API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Iowa-specific API data to standard DataGod format.
...
def get_ia_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> IowaAPI:
    """
    Get a configured Iowa API instance.
    ...
    Returns:
        Configured IowaAPI instance
    """
    return IowaAPI(jurisdiction_id, config)
