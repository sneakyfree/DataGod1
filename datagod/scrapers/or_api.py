"""
Oregon State API Integration
Auto-generated scraper for Oregon (OR) public records

Generated: 2025-12-31T16:35:15.433090
"""
...
COUNTY_APIS = {
    "multnomah": {
        "name": "Multnomah",
        "base_url": "https://multco.us/recording/api",
    ...
    "washington": {
        "name": "Washington",
        "base_url": "https://www.co.washington.or.us/AssessmentTaxation/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "clackamas": {
        "name": "Clackamas",
        "base_url": "https://www.clackamas.us/recording/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "lane": {
        "name": "Lane",
        "base_url": "https://lanecounty.org/government/county_departments/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "marion": {
        "name": "Marion",
        "base_url": "https://www.co.marion.or.us/CS/Clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "jackson": {
        "name": "Jackson",
        "base_url": "https://jacksoncountyor.gov/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class OregonAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Oregon (OR) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Oregon API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Oregon API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Oregon-specific API data to standard DataGod format.
...
def get_or_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> OregonAPI:
    """
    Get a configured Oregon API instance.
    ...
    Returns:
        Configured OregonAPI instance
    """
    return OregonAPI(jurisdiction_id, config)
