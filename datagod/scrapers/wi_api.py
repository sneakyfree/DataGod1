"""
Wisconsin State API Integration
Auto-generated scraper for Wisconsin (WI) public records

Generated: 2025-12-31T16:35:15.430688
"""
...
COUNTY_APIS = {
    "milwaukee": {
        "name": "Milwaukee",
        "base_url": "https://county.milwaukee.gov/EN/Register-of-Deeds/api",
    ...
    "dane": {
        "name": "Dane",
        "base_url": "https://register.countyofdane.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "waukesha": {
        "name": "Waukesha",
        "base_url": "https://www.waukeshacounty.gov/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "brown": {
        "name": "Brown",
        "base_url": "https://www.browncountywi.gov/departments/register-of-deeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "racine": {
        "name": "Racine",
        "base_url": "https://www.racinecounty.com/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "kenosha": {
        "name": "Kenosha",
        "base_url": "https://www.kenoshacounty.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class WisconsinAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Wisconsin (WI) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Wisconsin API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Wisconsin API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Wisconsin-specific API data to standard DataGod format.
...
def get_wi_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> WisconsinAPI:
    """
    Get a configured Wisconsin API instance.
    ...
    Returns:
        Configured WisconsinAPI instance
    """
    return WisconsinAPI(jurisdiction_id, config)
