"""
Louisiana State API Integration
Auto-generated scraper for Louisiana (LA) public records

Generated: 2025-12-31T17:18:20.835991
"""
...
COUNTY_APIS = {
    "orleans": {
        "name": "Orleans",
        "base_url": "https://www.orleanscivilclerk.com/api",
    ...
    "east_baton_rouge": {
        ...
        "base_url": "https://www.ebrclerkofcourt.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "jefferson": {
        "name": "Jefferson",
        "base_url": "https://www.jpclerkofcourt.us/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "caddo": {
        "name": "Caddo",
        "base_url": "https://www.caddoclerk.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "st._tammany": {
        "name": "St. Tammany",
        "base_url": "https://www.sttammanyclerk.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "lafayette": {
        "name": "Lafayette",
        "base_url": "https://www.lafayetteclerk.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class LouisianaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Louisiana (LA) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Louisiana API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Louisiana API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Louisiana-specific API data to standard DataGod format.
...
def get_la_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> LouisianaAPI:
    """
    Get a configured Louisiana API instance.
    ...
    Returns:
        Configured LouisianaAPI instance
    """
    return LouisianaAPI(jurisdiction_id, config)
