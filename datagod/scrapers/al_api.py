"""
Alabama State API Integration
Auto-generated scraper for Alabama (AL) public records

Generated: 2025-12-31T16:35:15.436745
"""
...
COUNTY_APIS = {
    'jefferson': {
        'name': 'Jefferson',
        'base_url': 'https://www.jeffcoprobate.alacourt.gov/api',
    ...
    'mobile': {
        'name': 'Mobile',
        'base_url': 'https://www.mobilecountyprobatecourt.gov/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'madison': {
        'name': 'Madison',
        'base_url': 'https://www.madisoncountyprobateal.com/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'baldwin': {
        'name': 'Baldwin',
        'base_url': 'https://www.baldwincountyal.gov/probate/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'montgomery': {
        'name': 'Montgomery',
        'base_url': 'https://www.montgomerycountyprobate.com/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'shelby': {
        'name': 'Shelby',
        'base_url': 'https://shelbyal.com/probate/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
...
class AlabamaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Alabama (AL) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Alabama API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Alabama API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map Alabama-specific API data to standard DataGod format.
...
def get_al_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> AlabamaAPI:
    """
    Get a configured Alabama API instance.
    ...
    Returns:
        Configured AlabamaAPI instance
    """
    return AlabamaAPI(jurisdiction_id, config)
