"""
North Dakota State API Integration
Auto-generated scraper for North Dakota (ND) public records

Generated: 2025-12-31T17:39:32.341895
"""
...
COUNTY_APIS = {
    'cass': {
        'name': 'Cass',
        'base_url': 'https://www.casscountynd.gov/recorder/api',
    ...
    'burleigh': {
        'name': 'Burleigh',
        'base_url': 'https://www.burleighco.com/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'grand_forks': {
        'name': 'Grand Forks',
        'base_url': 'https://www.gfcounty.nd.gov/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'ward': {
        'name': 'Ward',
        'base_url': 'https://www.co.ward.nd.us/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'williams': {
        'name': 'Williams',
        'base_url': 'https://www.williamsnd.com/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'stark': {
        'name': 'Stark',
        'base_url': 'https://www.starknd.com/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
...
class NorthDakotaAPI(BaseAPIIntegration):
    """
    API integration for North Dakota (ND) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the North Dakota API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the North Dakota API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map North Dakota-specific API data to standard DataGod format.
...
def get_nd_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> NorthDakotaAPI:
    """
    Get a configured North Dakota API instance.
    ...
    Returns:
        Configured NorthDakotaAPI instance
    """
    return NorthDakotaAPI(jurisdiction_id, config)
