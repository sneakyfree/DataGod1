"""
Wyoming State API Integration
Auto-generated scraper for Wyoming (WY) public records

Generated: 2025-12-31T17:39:32.349414
"""
...
COUNTY_APIS = {
    'laramie': {
        'name': 'Laramie',
        'base_url': 'https://www.laramiecounty.com/clerk/api',
    ...
    'natrona': {
        'name': 'Natrona',
        'base_url': 'https://www.natronacounty-wy.gov/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'campbell': {
        'name': 'Campbell',
        'base_url': 'https://www.ccgov.net/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'sweetwater': {
        'name': 'Sweetwater',
        'base_url': 'https://www.sweetwatercountywy.gov/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'fremont': {
        'name': 'Fremont',
        'base_url': 'https://www.fremontcountywy.org/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'albany': {
        'name': 'Albany',
        'base_url': 'https://www.co.albany.wy.us/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
...
class WyomingAPI(BaseAPIIntegration):
    """
    API integration for Wyoming (WY) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Wyoming API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Wyoming API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map Wyoming-specific API data to standard DataGod format.
...
def get_wy_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> WyomingAPI:
    """
    Get a configured Wyoming API instance.
    ...
    Returns:
        Configured WyomingAPI instance
    """
    return WyomingAPI(jurisdiction_id, config)
