"""
Rhode Island State API Integration
Auto-generated scraper for Rhode Island (RI) public records

Generated: 2025-12-31T17:39:32.344364
"""
...
COUNTY_APIS = {
    'providence': {
        'name': 'Providence',
        'base_url': 'https://www.providenceri.gov/recorder/api',
    ...
    'kent': {
        'name': 'Kent',
        'base_url': 'https://www.kentcountyri.org/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'washington': {
        'name': 'Washington',
        'base_url': 'https://www.washingtonri.org/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'newport': {
        'name': 'Newport',
        'base_url': 'https://www.newportcountyri.gov/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'bristol': {
        'name': 'Bristol',
        'base_url': 'https://www.bristolcountyri.gov/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
...
class RhodeIslandAPI(BaseAPIIntegration):
    """
    API integration for Rhode Island (RI) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Rhode Island API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Rhode Island API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map Rhode Island-specific API data to standard DataGod format.
...
def get_ri_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> RhodeIslandAPI:
    """
    Get a configured Rhode Island API instance.
    ...
    Returns:
        Configured RhodeIslandAPI instance
    """
    return RhodeIslandAPI(jurisdiction_id, config)
