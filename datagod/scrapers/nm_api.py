"""
New Mexico State API Integration
Auto-generated scraper for New Mexico (NM) public records

Generated: 2025-12-31T17:18:20.846152
"""
...
COUNTY_APIS = {
    "bernalillo": {
        "name": "Bernalillo",
        "base_url": "https://www.bernco.gov/clerk/api",
    ...
    "dona_ana": {
        "name": "Dona Ana",
        "base_url": "https://www.donaanacounty.org/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "santa_fe": {
        "name": "Santa Fe",
        "base_url": "https://www.santafecountynm.gov/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "sandoval": {
        "name": "Sandoval",
        "base_url": "https://www.sandovalcountynm.gov/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "san_juan": {
        "name": "San Juan",
        "base_url": "https://www.sjcounty.net/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "valencia": {
        "name": "Valencia",
        "base_url": "https://www.valenciacounty.com/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class NewMexicoAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for New Mexico (NM) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the New Mexico API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the New Mexico API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map New Mexico-specific API data to standard DataGod format.
...
def get_nm_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> NewMexicoAPI:
    """
    Get a configured New Mexico API instance.
    ...
    Returns:
        Configured NewMexicoAPI instance
    """
    return NewMexicoAPI(jurisdiction_id, config)
