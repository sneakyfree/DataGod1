"""
Hawaii State API Integration
Auto-generated scraper for Hawaii (HI) public records

Generated: 2025-12-31T17:39:32.334384
"""
...
COUNTY_APIS = {
    "honolulu": {
        "name": "Honolulu",
        "base_url": "https://www.honolulu.gov/bfs/api",
    ...
    "hawaii": {
        "name": "Hawaii",
        "base_url": "https://www.hawaiicounty.gov/finance/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "maui": {
        "name": "Maui",
        "base_url": "https://www.mauicounty.gov/finance/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "kauai": {
        "name": "Kauai",
        "base_url": "https://www.kauai.gov/finance/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
...
class HawaiiAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Hawaii (HI) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Hawaii API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Hawaii API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Hawaii-specific API data to standard DataGod format.
...
def get_hi_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> HawaiiAPI:
    """
    Get a configured Hawaii API instance.
    ...
    Returns:
        Configured HawaiiAPI instance
    """
    return HawaiiAPI(jurisdiction_id, config)
