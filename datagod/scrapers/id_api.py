"""
Idaho State API Integration
Auto-generated scraper for Idaho (ID) public records

Generated: 2025-12-31T17:39:32.335586
"""
...
COUNTY_APIS = {
    "ada": {
        "name": "Ada",
        "base_url": "https://www.adacounty.id.gov/recorder/api",
    ...
    "canyon": {
        "name": "Canyon",
        "base_url": "https://www.canyoncounty.id.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "kootenai": {
        "name": "Kootenai",
        "base_url": "https://www.kcgov.us/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "bonneville": {
        "name": "Bonneville",
        "base_url": "https://www.co.bonneville.id.us/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "twin_falls": {
        "name": "Twin Falls",
        "base_url": "https://www.twinfallscounty.org/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class IdahoAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Idaho (ID) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Idaho API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Idaho API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Idaho-specific API data to standard DataGod format.
...
def get_id_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> IdahoAPI:
    """
    Get a configured Idaho API instance.
    ...
    Returns:
        Configured IdahoAPI instance
    """
    return IdahoAPI(jurisdiction_id, config)
