...
class ScraperLogger:
    ...
    def __init__(self, db_session: Optional[Session] = None):
        ...
        if not self.db_session:
            ...
            try:
                ...
                logger.error(f"Failed to initialize DB connection for ScraperLogger: {e}")

    def log_run_start(self, scraper_name: str, jurisdiction_id: Optional[int] = None, data_category: str = 'general') -> int:
        """
    ...
    def log_run_end(self, run_id: int, status: str, items_scraped: int = 0, error_message: Optional[str] = None):
        """
