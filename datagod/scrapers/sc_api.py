"""
South Carolina State API Integration
Auto-generated scraper for South Carolina (SC) public records

Generated: 2025-12-31T16:35:15.435495
"""
...
COUNTY_APIS = {
    "greenville": {
        "name": "Greenville",
        "base_url": "https://www.greenvillecounty.org/registerofdeeds/api",
    ...
    "richland": {
        "name": "Richland",
        "base_url": "https://www.richlandcountysc.gov/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "charleston": {
        "name": "Charleston",
        "base_url": "https://www.charlestoncounty.org/departments/rod/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "horry": {
        "name": "Horry",
        "base_url": "https://www.horrycounty.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "spartanburg": {
        "name": "Spartanburg",
        "base_url": "https://www.spartanburgcounty.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "lexington": {
        "name": "Lexington",
        "base_url": "https://lex-co.sc.gov/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class SouthCarolinaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for South Carolina (SC) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the South Carolina API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the South Carolina API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map South Carolina-specific API data to standard DataGod format.
...
def get_sc_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> SouthCarolinaAPI:
    """
    Get a configured South Carolina API instance.
    ...
    Returns:
        Configured SouthCarolinaAPI instance
    """
    return SouthCarolinaAPI(jurisdiction_id, config)
