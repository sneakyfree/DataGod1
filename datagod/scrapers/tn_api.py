"""
Tennessee State API Integration
Auto-generated scraper for Tennessee (TN) public records

Generated: 2025-12-31T16:35:15.425272
"""
...
COUNTY_APIS = {
    "shelby": {
        "name": "Shelby",
        "base_url": "https://register.shelby.tn.us/api",
    ...
    "davidson": {
        "name": "Davidson",
        "base_url": "https://rod.nashville.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "knox": {
        "name": "Knox",
        "base_url": "https://register.knoxcounty.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "hamilton": {
        "name": "Hamilton",
        "base_url": "https://register.hamiltontn.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "rutherford": {
        "name": "Rutherford",
        "base_url": "https://register.rutherfordcountytn.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "williamson": {
        "name": "Williamson",
        "base_url": "https://rod.williamsoncounty-tn.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "sumner": {
        "name": "Sumner",
        "base_url": "https://register.sumnertn.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "montgomery": {
        "name": "Montgomery",
        "base_url": "https://register.mcgtn.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class TennesseeAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Tennessee (TN) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Tennessee API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Tennessee API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Tennessee-specific API data to standard DataGod format.
...
def get_tn_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> TennesseeAPI:
    """
    Get a configured Tennessee API instance.
    ...
    Returns:
        Configured TennesseeAPI instance
    """
    return TennesseeAPI(jurisdiction_id, config)
