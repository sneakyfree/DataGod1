"""
Michigan State API Integration
Auto-generated scraper for Michigan (MI) public records

Generated: 2025-12-31T17:39:32.339411
"""
...
COUNTY_APIS = {
    "wayne": {
        "name": "Wayne",
        "base_url": "https://www.waynecounty.com/registerofdeeds/api",
    ...
    "oakland": {
        "name": "Oakland",
        "base_url": "https://www.oakgov.com/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "macomb": {
        "name": "Macomb",
        "base_url": "https://www.macombgov.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "kent": {
        "name": "Kent",
        "base_url": "https://www.accesskent.com/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "genesee": {
        "name": "Genesee",
        "base_url": "https://www.gc4me.com/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "washtenaw": {
        "name": "Washtenaw",
        "base_url": "https://www.washtenaw.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "ingham": {
        "name": "Ingham",
        "base_url": "https://www.ingham.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "ottawa": {
        "name": "Ottawa",
        "base_url": "https://www.miottawa.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class MichiganAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Michigan (MI) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Michigan API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Michigan API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Michigan-specific API data to standard DataGod format.
...
def get_mi_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> MichiganAPI:
    """
    Get a configured Michigan API instance.
    ...
    Returns:
        Configured MichiganAPI instance
    """
    return MichiganAPI(jurisdiction_id, config)
