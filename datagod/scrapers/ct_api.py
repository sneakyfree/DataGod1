"""
Connecticut State API Integration
Auto-generated scraper for Connecticut (CT) public records

Generated: 2025-12-31T17:18:20.838496
"""
...
COUNTY_APIS = {
    "fairfield": {
        "name": "Fairfield",
        "base_url": "https://www.fairfieldct.org/townclerk/api",
    ...
    "hartford": {
        "name": "Hartford",
        "base_url": "https://www.hartford.gov/townclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "new_haven": {
        "name": "New Haven",
        "base_url": "https://www.newhavenct.gov/townclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "new_london": {
        "name": "New London",
        "base_url": "https://www.newlondonct.gov/townclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "litchfield": {
        "name": "Litchfield",
        "base_url": "https://www.litchfieldct.com/townclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "middlesex": {
        "name": "Middlesex",
        "base_url": "https://www.middlesexcountyct.gov/townclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class ConnecticutAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Connecticut (CT) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Connecticut API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Connecticut API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Connecticut-specific API data to standard DataGod format.
...
def get_ct_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> ConnecticutAPI:
    """
    Get a configured Connecticut API instance.
    ...
    Returns:
        Configured ConnecticutAPI instance
    """
    return ConnecticutAPI(jurisdiction_id, config)
