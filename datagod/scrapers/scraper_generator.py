...
class ScraperGenerator:
    ...
    def __init__(self,
        ...
        logger.info(f"ScraperGenerator initialized: templates={self.templates_dir}, configs={self.configs_dir}")
    ...
    def generate_scraper(self, config: Dict[str, Any], template: str = None) -> str:
        ...
        data_source_methods = self._generate_data_source_methods(config.get('data_sources', {}))
    ...
    def _generate_county_apis(self, counties: List[Dict[str, Any]]) -> str:
        ...
        for county in counties:
            ...
            county_config = {
                ...
                'property_endpoint': county.get('property_endpoint', '/property/search'),
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        print(f"=====================")
        print(f"States with scrapers: {report['covered_states']}/{report['total_states']} ({report['coverage_percentage']:.1f}%)")
        print(f"Territories with scrapers: {report['covered_territories']}/{report['total_territories']}")
