...
class JurisdictionResearcher:
    ...
    def save_jurisdiction_data(self, jurisdictions: List[Jurisdiction], filename: str = 'jurisdictions.csv'):
        ...
        with open(csv_path, 'w', newline='', encoding='utf-8') as csvfile:
            fieldnames = [
                'name', 'state', 'county', 'type', 'website',
                'api_available', 'api_documentation', 'scraper_needed',
                'data_volume', 'priority', 'notes'
            ]
        ...
        logger.info(f"Saved {len(jurisdictions)} jurisdictions to {csv_path} and {json_path}")

    def research_top_states(self, state_codes: List[str] = ['CA', 'TX', 'FL', 'NY', 'IL']):
