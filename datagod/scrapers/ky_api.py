"""
Kentucky State API Integration
Auto-generated scraper for Kentucky (KY) public records

Generated: 2025-12-31T17:18:20.833942
"""
...
COUNTY_APIS = {
    "jefferson": {
        "name": "Jefferson",
        "base_url": "https://jeffersoncountyclerk.org/api",
    ...
    "fayette": {
        "name": "Fayette",
        "base_url": "https://fayettecountyclerk.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "kenton": {
        "name": "Kenton",
        "base_url": "https://kentoncountyclerk.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "boone": {
        "name": "Boone",
        "base_url": "https://boonecountyclerk.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "warren": {
        "name": "Warren",
        "base_url": "https://warrencountyclerk.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "hardin": {
        "name": "Hardin",
        "base_url": "https://hardincountyclerk.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class KentuckyAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Kentucky (KY) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Kentucky API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Kentucky API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Kentucky-specific API data to standard DataGod format.
...
def get_ky_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> KentuckyAPI:
    """
    Get a configured Kentucky API instance.
    ...
    Returns:
        Configured KentuckyAPI instance
    """
    return KentuckyAPI(jurisdiction_id, config)
