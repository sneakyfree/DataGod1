"""
New Hampshire State API Integration
Auto-generated scraper for New Hampshire (NH) public records

Generated: 2025-12-31T17:39:32.343147
"""
...
COUNTY_APIS = {
    "hillsborough": {
        "name": "Hillsborough",
        "base_url": "https://www.hillsboroughcountynh.org/registerofdeeds/api",
    ...
    "rockingham": {
        "name": "Rockingham",
        "base_url": "https://www.rockinghamcountynh.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "merrimack": {
        "name": "Merrimack",
        "base_url": "https://www.merrimackcounty.net/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "strafford": {
        "name": "Strafford",
        "base_url": "https://www.co.strafford.nh.us/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "grafton": {
        "name": "Grafton",
        "base_url": "https://www.graftoncountynh.us/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "cheshire": {
        "name": "Cheshire",
        "base_url": "https://www.co.cheshire.nh.us/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
...
class NewHampshireAPI(BaseAPIIntegration):
    """
    API integration for New Hampshire (NH) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the New Hampshire API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the New Hampshire API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map New Hampshire-specific API data to standard DataGod format.
...
def get_nh_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> NewHampshireAPI:
    """
    Get a configured New Hampshire API instance.
    ...
    Returns:
        Configured NewHampshireAPI instance
    """
    return NewHampshireAPI(jurisdiction_id, config)
