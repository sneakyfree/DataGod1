"""
Oklahoma State API Integration
Auto-generated scraper for Oklahoma (OK) public records

Generated: 2025-12-31T17:18:20.837273
"""
...
COUNTY_APIS = {
    "oklahoma": {
        "name": "Oklahoma",
        "base_url": "https://countyclerk.oklahomacounty.org/api",
    ...
    "tulsa": {
        "name": "Tulsa",
        "base_url": "https://www.tulsacounty.org/countyclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "cleveland": {
        "name": "Cleveland",
        "base_url": "https://www.clevelandcountyok.com/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "canadian": {
        "name": "Canadian",
        "base_url": "https://www.canadiancounty.us/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "comanche": {
        "name": "Comanche",
        "base_url": "https://www.comanchecountyok.com/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "rogers": {
        "name": "Rogers",
        "base_url": "https://www.rogerscounty.org/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class OklahomaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Oklahoma (OK) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Oklahoma API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Oklahoma API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Oklahoma-specific API data to standard DataGod format.
...
def get_ok_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> OklahomaAPI:
    """
    Get a configured Oklahoma API instance.
    ...
    Returns:
        Configured OklahomaAPI instance
    """
    return OklahomaAPI(jurisdiction_id, config)
