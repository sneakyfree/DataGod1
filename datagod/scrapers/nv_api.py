"""
Nevada State API Integration
Auto-generated scraper for Nevada (NV) public records

Generated: 2025-12-31T16:35:15.434288
"""
...
COUNTY_APIS = {
    "clark": {
        "name": "Clark",
        "base_url": "https://www.clarkcountynv.gov/recorder/api",
    ...
    "washoe": {
        "name": "Washoe",
        "base_url": "https://www.washoecounty.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "carson_city": {
        "name": "Carson City",
        "base_url": "https://carson.org/government/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "douglas": {
        "name": "Douglas",
        "base_url": "https://www.douglascountynv.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "lyon": {
        "name": "Lyon",
        "base_url": "https://www.lyon-county.org/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "elko": {
        "name": "Elko",
        "base_url": "https://www.elkocountynv.net/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class NevadaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Nevada (NV) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Nevada API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Nevada API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Nevada-specific API data to standard DataGod format.
...
def get_nv_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> NevadaAPI:
    """
    Get a configured Nevada API instance.
    ...
    Returns:
        Configured NevadaAPI instance
    """
    return NevadaAPI(jurisdiction_id, config)
