"""
South Dakota State API Integration
Auto-generated scraper for South Dakota (SD) public records

Generated: 2025-12-31T17:39:32.345582
"""
...
COUNTY_APIS = {
    'minnehaha': {
        'name': 'Minnehaha',
        'base_url': 'https://www.minnehahacounty.org/registerofdeeds/api',
    ...
    'pennington': {
        'name': 'Pennington',
        'base_url': 'https://www.pennco.org/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'lincoln': {
        'name': 'Lincoln',
        'base_url': 'https://www.lincolncountysd.org/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'brown': {
        'name': 'Brown',
        'base_url': 'https://www.brown.sd.us/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'codington': {
        'name': 'Codington',
        'base_url': 'https://www.codington.org/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'brookings': {
        'name': 'Brookings',
        'base_url': 'https://www.brookingscountysd.gov/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
...
class SouthDakotaAPI(BaseAPIIntegration):
    """
    API integration for South Dakota (SD) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the South Dakota API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the South Dakota API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map South Dakota-specific API data to standard DataGod format.
...
def get_sd_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> SouthDakotaAPI:
    """
    Get a configured South Dakota API instance.
    ...
    Returns:
        Configured SouthDakotaAPI instance
    """
    return SouthDakotaAPI(jurisdiction_id, config)
