"""
Northern Mariana Islands State API Integration
Auto-generated scraper for Northern Mariana Islands (MP) public records

Generated: 2025-12-31T17:42:45.162716
"""
...
COUNTY_APIS = {
    'saipan': {
        'name': 'Saipan',
        'base_url': 'https://www.dlnr.gov.mp/recorder/api',
...
class NorthernMarianaIslandsAPI(BaseAPIIntegration):
    """
    API integration for Northern Mariana Islands (MP) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Northern Mariana Islands API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Northern Mariana Islands API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map Northern Mariana Islands-specific API data to standard DataGod format.
...
def get_mp_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> NorthernMarianaIslandsAPI:
    """
    Get a configured Northern Mariana Islands API instance.
    ...
    Returns:
        Configured NorthernMarianaIslandsAPI instance
    """
    return NorthernMarianaIslandsAPI(jurisdiction_id, config)
