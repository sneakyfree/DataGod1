"""
Kansas State API Integration
Auto-generated scraper for Kansas (KS) public records

Generated: 2025-12-31T17:18:20.844944
"""
...
COUNTY_APIS = {
    "johnson": {
        "name": "Johnson",
        "base_url": "https://www.jocogov.org/registerofdeeds/api",
    ...
    "sedgwick": {
        "name": "Sedgwick",
        "base_url": "https://www.sedgwickcounty.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "shawnee": {
        "name": "Shawnee",
        "base_url": "https://www.snco.us/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "wyandotte": {
        "name": "Wyandotte",
        "base_url": "https://www.wycokck.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "douglas": {
        "name": "Douglas",
        "base_url": "https://www.douglascountyks.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "leavenworth": {
        "name": "Leavenworth",
        "base_url": "https://www.leavenworthcounty.gov/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class KansasAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Kansas (KS) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Kansas API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Kansas API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Kansas-specific API data to standard DataGod format.
...
def get_ks_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> KansasAPI:
    """
    Get a configured Kansas API instance.
    ...
    Returns:
        Configured KansasAPI instance
    """
    return KansasAPI(jurisdiction_id, config)
