"""
American Samoa State API Integration
Auto-generated scraper for American Samoa (AS) public records

Generated: 2025-12-31T17:42:45.161517
"""
...
COUNTY_APIS = {
    "eastern_district": {
        ...
        "base_url": "https://www.asbar.org/landrecords/api",
...
class AmericanSamoaAPI(BaseAPIIntegration):
    """
    API integration for American Samoa (AS) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the American Samoa API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the American Samoa API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map American Samoa-specific API data to standard DataGod format.
...
def get_as_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> AmericanSamoaAPI:
    """
    Get a configured American Samoa API instance.
    ...
    Returns:
        Configured AmericanSamoaAPI instance
    """
    return AmericanSamoaAPI(jurisdiction_id, config)
