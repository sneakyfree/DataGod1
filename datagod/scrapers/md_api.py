"""
Maryland State API Integration
Auto-generated scraper for Maryland (MD) public records

Generated: 2025-12-31T16:35:15.428299
"""
...
COUNTY_APIS = {
    "montgomery": {
        "name": "Montgomery",
        "base_url": "https://sdat.dat.maryland.gov/api/montgomery",
    ...
    "prince_georges": {
        "name": "Prince Georges",
        "base_url": "https://sdat.dat.maryland.gov/api/princegeorges",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "baltimore_county": {
        ...
        "base_url": "https://sdat.dat.maryland.gov/api/baltimorecounty",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "baltimore_city": {
        "name": "Baltimore City",
        "base_url": "https://sdat.dat.maryland.gov/api/baltimorecity",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "anne_arundel": {
        "name": "Anne Arundel",
        "base_url": "https://sdat.dat.maryland.gov/api/annearundel",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "howard": {
        "name": "Howard",
        "base_url": "https://sdat.dat.maryland.gov/api/howard",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "frederick": {
        "name": "Frederick",
        "base_url": "https://sdat.dat.maryland.gov/api/frederick",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "harford": {
        "name": "Harford",
        "base_url": "https://sdat.dat.maryland.gov/api/harford",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class MarylandAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Maryland (MD) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Maryland API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Maryland API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Maryland-specific API data to standard DataGod format.
...
def get_md_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> MarylandAPI:
    """
    Get a configured Maryland API instance.
    ...
    Returns:
        Configured MarylandAPI instance
    """
    return MarylandAPI(jurisdiction_id, config)
