"""
Minnesota State API Integration
Auto-generated scraper for Minnesota (MN) public records

Generated: 2025-12-31T16:35:15.431876
"""
...
COUNTY_APIS = {
    'hennepin': {
        'name': 'Hennepin',
        'base_url': 'https://www.hennepin.us/residents/property/api',
    ...
    'ramsey': {
        'name': 'Ramsey',
        'base_url': 'https://www.ramseycounty.us/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'dakota': {
        'name': 'Dakota',
        'base_url': 'https://www.co.dakota.mn.us/PropertyTaxation/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'anoka': {
        'name': 'Anoka',
        'base_url': 'https://www.anokacountymn.gov/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'washington': {
        'name': 'Washington',
        'base_url': 'https://www.washingtoncountymn.gov/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'scott': {
        'name': 'Scott',
        'base_url': 'https://www.scottcountymn.gov/recorder/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
...
class MinnesotaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Minnesota (MN) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Minnesota API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Minnesota API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map Minnesota-specific API data to standard DataGod format.
...
def get_mn_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> MinnesotaAPI:
    """
    Get a configured Minnesota API instance.
    ...
    Returns:
        Configured MinnesotaAPI instance
    """
    return MinnesotaAPI(jurisdiction_id, config)
