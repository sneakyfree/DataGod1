"""
Nebraska State API Integration
Auto-generated scraper for Nebraska (NE) public records

Generated: 2025-12-31T17:18:20.847383
"""
...
COUNTY_APIS = {
    'douglas': {
        'name': 'Douglas',
        'base_url': 'https://www.douglascounty-ne.gov/registerofdeeds/api',
    ...
    'lancaster': {
        'name': 'Lancaster',
        'base_url': 'https://www.lancaster.ne.gov/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'sarpy': {
        'name': 'Sarpy',
        'base_url': 'https://www.sarpy.com/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'hall': {
        'name': 'Hall',
        'base_url': 'https://www.hallcountyne.gov/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'buffalo': {
        'name': 'Buffalo',
        'base_url': 'https://www.buffalocounty.ne.gov/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'dodge': {
        'name': 'Dodge',
        'base_url': 'https://www.dodgecounty.ne.gov/registerofdeeds/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
...
class NebraskaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Nebraska (NE) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Nebraska API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Nebraska API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map Nebraska-specific API data to standard DataGod format.
...
def get_ne_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> NebraskaAPI:
    """
    Get a configured Nebraska API instance.
    ...
    Returns:
        Configured NebraskaAPI instance
    """
    return NebraskaAPI(jurisdiction_id, config)
