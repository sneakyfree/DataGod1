"""
Puerto Rico State API Integration
Auto-generated scraper for Puerto Rico (PR) public records

Generated: 2025-12-31T17:42:45.157390
"""
...
COUNTY_APIS = {
    'san_juan': {
        'name': 'San Juan',
        'base_url': 'https://www.registrodelapropiedad.pr.gov/api',
...
class PuertoRicoAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Puerto Rico (PR) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Puerto Rico API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Puerto Rico API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map Puerto Rico-specific API data to standard DataGod format.
...
def get_pr_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> PuertoRicoAPI:
    """
    Get a configured Puerto Rico API instance.
    ...
    Returns:
        Configured PuertoRicoAPI instance
    """
    return PuertoRicoAPI(jurisdiction_id, config)
