"""
Alaska State API Integration
Auto-generated scraper for Alaska (AK) public records

Generated: 2025-12-31T17:39:32.331421
"""
...
COUNTY_APIS = {
    "anchorage": {
        "name": "Anchorage",
        "base_url": "https://www.muni.org/recorder/api",
    ...
    "fairbanks_north_star": {
        ...
        "base_url": "https://www.fnsb.gov/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "matanuska-susitna": {
        ...
        "base_url": "https://www.matsugov.us/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "kenai_peninsula": {
        ...
        "base_url": "https://www.kpb.us/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "juneau": {
        "name": "Juneau",
        "base_url": "https://juneau.org/recorder/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class AlaskaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Alaska (AK) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Alaska API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Alaska API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Alaska-specific API data to standard DataGod format.
...
def get_ak_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> AlaskaAPI:
    """
    Get a configured Alaska API instance.
    ...
    Returns:
        Configured AlaskaAPI instance
    """
    return AlaskaAPI(jurisdiction_id, config)
