"""
Indiana State API Integration
Auto-generated scraper for Indiana (IN) public records

Generated: 2025-12-31T16:35:15.426982
"""
...
COUNTY_APIS = {
    "marion": {
        "name": "Marion",
        "base_url": "https://recorder.indy.gov/api",
    ...
    "lake": {
        "name": "Lake",
        "base_url": "https://recorder.lakecountyin.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "allen": {
        "name": "Allen",
        "base_url": "https://recorder.allencounty.us/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "hamilton": {
        "name": "Hamilton",
        "base_url": "https://recorder.hamiltoncounty.in.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "st._joseph": {
        "name": "St. Joseph",
        "base_url": "https://recorder.sjcindiana.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "elkhart": {
        "name": "Elkhart",
        "base_url": "https://recorder.elkhartcounty.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "tippecanoe": {
        "name": "Tippecanoe",
        "base_url": "https://recorder.tippecanoe.in.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "vanderburgh": {
        "name": "Vanderburgh",
        "base_url": "https://recorder.vanderburghgov.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class IndianaAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Indiana (IN) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Indiana API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Indiana API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Indiana-specific API data to standard DataGod format.
...
def get_in_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> IndianaAPI:
    """
    Get a configured Indiana API instance.
    ...
    Returns:
        Configured IndianaAPI instance
    """
    return IndianaAPI(jurisdiction_id, config)
