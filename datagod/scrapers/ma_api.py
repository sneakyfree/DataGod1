"""
Massachusetts State API Integration
Auto-generated scraper for Massachusetts (MA) public records

Generated: 2025-12-31T17:39:32.336960
"""
...
COUNTY_APIS = {
    "middlesex": {
        "name": "Middlesex",
        "base_url": "https://www.middlesexdeeds.com/api",
    ...
    "suffolk": {
        "name": "Suffolk",
        "base_url": "https://www.suffolkdeeds.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "worcester": {
        "name": "Worcester",
        "base_url": "https://www.worcesterdeeds.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "essex": {
        "name": "Essex",
        "base_url": "https://www.essexdeeds.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "norfolk": {
        "name": "Norfolk",
        "base_url": "https://www.norfolkdeeds.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "bristol": {
        "name": "Bristol",
        "base_url": "https://www.bristoldeeds.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class MassachusettsAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Massachusetts (MA) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Massachusetts API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Massachusetts API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Massachusetts-specific API data to standard DataGod format.
...
def get_ma_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> MassachusettsAPI:
    """
    Get a configured Massachusetts API instance.
    ...
    Returns:
        Configured MassachusettsAPI instance
    """
    return MassachusettsAPI(jurisdiction_id, config)
