"""
Delaware State API Integration
Auto-generated scraper for Delaware (DE) public records

Generated: 2025-12-31T17:39:32.333163
"""
...
class DelawareAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Delaware (DE) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Delaware API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Delaware API.
...
def get_de_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> DelawareAPI:
    """
    Get a configured Delaware API instance.
    ...
    Returns:
        Configured DelawareAPI instance
    """
    return DelawareAPI(jurisdiction_id, config)
