"""
Arkansas State API Integration
Auto-generated scraper for Arkansas (AR) public records

Generated: 2025-12-31T17:18:20.842483
"""
...
COUNTY_APIS = {
    'pulaski': {
        'name': 'Pulaski',
        'base_url': 'https://www.pulaskiclerk.com/api',
    ...
    'benton': {
        'name': 'Benton',
        'base_url': 'https://www.bentoncountyar.gov/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'washington': {
        'name': 'Washington',
        'base_url': 'https://www.washingtoncountyar.gov/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'sebastian': {
        'name': 'Sebastian',
        'base_url': 'https://www.sebastiancountyar.gov/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': False,
    ...
    'faulkner': {
        'name': 'Faulkner',
        'base_url': 'https://www.faulknercounty.org/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
    ...
    'saline': {
        'name': 'Saline',
        'base_url': 'https://www.salinecounty.org/clerk/api',
        'property_endpoint': '/property/search',
        'deed_endpoint': '/deed/search',
        'lien_endpoint': '/lien/search',
        'requires_auth': True,
...
class ArkansasAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Arkansas (AR) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Arkansas API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Arkansas API.
    ...
    def map_api_data_to_standard_format(self, api_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Map Arkansas-specific API data to standard DataGod format.
...
def get_ar_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> ArkansasAPI:
    """
    Get a configured Arkansas API instance.
    ...
    Returns:
        Configured ArkansasAPI instance
    """
    return ArkansasAPI(jurisdiction_id, config)
