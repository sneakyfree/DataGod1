"""
Missouri State API Integration
Auto-generated scraper for Missouri (MO) public records

Generated: 2025-12-31T16:35:15.429505
"""
...
COUNTY_APIS = {
    "st._louis_county": {
        ...
        "base_url": "https://recorder.stlouisco.com/api",
    ...
    "jackson": {
        "name": "Jackson",
        "base_url": "https://recorder.jacksoncountygov.com/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "st._louis_city": {
        "name": "St. Louis City",
        "base_url": "https://recorder.stlouis-mo.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "st._charles": {
        "name": "St. Charles",
        "base_url": "https://recorder.sccmo.org/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "greene": {
        "name": "Greene",
        "base_url": "https://recorder.greenecountymo.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "clay": {
        "name": "Clay",
        "base_url": "https://recorder.claycountymo.gov/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class MissouriAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Missouri (MO) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Missouri API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Missouri API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Missouri-specific API data to standard DataGod format.
...
def get_mo_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> MissouriAPI:
    """
    Get a configured Missouri API instance.
    ...
    Returns:
        Configured MissouriAPI instance
    """
    return MissouriAPI(jurisdiction_id, config)
