"""
Maine State API Integration
Auto-generated scraper for Maine (ME) public records

Generated: 2025-12-31T17:39:32.338198
"""
...
COUNTY_APIS = {
    "cumberland": {
        "name": "Cumberland",
        "base_url": "https://www.cumberlandcounty.org/registerofdeeds/api",
    ...
    "york": {
        "name": "York",
        "base_url": "https://www.yorkcountymaine.gov/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "penobscot": {
        "name": "Penobscot",
        "base_url": "https://www.penobscot-county.net/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "kennebec": {
        "name": "Kennebec",
        "base_url": "https://www.kennebeccounty.org/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "androscoggin": {
        "name": "Androscoggin",
        "base_url": "https://www.androscoggincountymaine.gov/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "aroostook": {
        "name": "Aroostook",
        "base_url": "https://www.aroostook.me.us/registerofdeeds/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
...
class MaineAPI(BaseAPIIntegration):
    """
    API integration for Maine (ME) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Maine API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Maine API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Maine-specific API data to standard DataGod format.
...
def get_me_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> MaineAPI:
    """
    Get a configured Maine API instance.
    ...
    Returns:
        Configured MaineAPI instance
    """
    return MaineAPI(jurisdiction_id, config)
