"""
Guam State API Integration
Auto-generated scraper for Guam (GU) public records

Generated: 2025-12-31T17:42:45.159128
"""
...
COUNTY_APIS = {
    "guam": {
        "name": "Guam",
        "base_url": "https://www.guamlandrecords.com/api",
...
class GuamAPI(BaseAPIIntegration):
    """
    API integration for Guam (GU) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Guam API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Guam API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Guam-specific API data to standard DataGod format.
...
def get_gu_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> GuamAPI:
    """
    Get a configured Guam API instance.
    ...
    Returns:
        Configured GuamAPI instance
    """
    return GuamAPI(jurisdiction_id, config)
