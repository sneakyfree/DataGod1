"""
Montana State API Integration
Auto-generated scraper for Montana (MT) public records

Generated: 2025-12-31T17:39:32.340668
"""
...
COUNTY_APIS = {
    "yellowstone": {
        "name": "Yellowstone",
        "base_url": "https://www.co.yellowstone.mt.gov/clerk/api",
    ...
    "missoula": {
        "name": "Missoula",
        "base_url": "https://www.missoulacounty.us/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "gallatin": {
        "name": "Gallatin",
        "base_url": "https://www.gallatin.mt.gov/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "flathead": {
        "name": "Flathead",
        "base_url": "https://www.flathead.mt.gov/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "cascade": {
        "name": "Cascade",
        "base_url": "https://www.cascadecountymt.gov/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "lewis_and_clark": {
        ...
        "base_url": "https://www.lccountymt.gov/clerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
...
class MontanaAPI(BaseAPIIntegration):
    """
    API integration for Montana (MT) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Montana API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Montana API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Montana-specific API data to standard DataGod format.
...
def get_mt_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> MontanaAPI:
    """
    Get a configured Montana API instance.
    ...
    Returns:
        Configured MontanaAPI instance
    """
    return MontanaAPI(jurisdiction_id, config)
