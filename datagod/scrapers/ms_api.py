"""
Mississippi State API Integration
Auto-generated scraper for Mississippi (MS) public records

Generated: 2025-12-31T17:18:20.843746
"""
...
COUNTY_APIS = {
    "hinds": {
        "name": "Hinds",
        "base_url": "https://www.co.hinds.ms.us/chanceryclerk/api",
    ...
    "harrison": {
        "name": "Harrison",
        "base_url": "https://www.co.harrison.ms.us/chanceryclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "desoto": {
        "name": "DeSoto",
        "base_url": "https://www.desotocountyms.gov/chanceryclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "rankin": {
        "name": "Rankin",
        "base_url": "https://www.rankincounty.org/chanceryclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": False,
    ...
    "jackson": {
        "name": "Jackson",
        "base_url": "https://www.co.jackson.ms.us/chanceryclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
    ...
    "madison": {
        "name": "Madison",
        "base_url": "https://www.madison-co.com/chanceryclerk/api",
        "property_endpoint": "/property/search",
        "deed_endpoint": "/deed/search",
        "lien_endpoint": "/lien/search",
        "requires_auth": True,
...
class MississippiAPI(APIKeyAuthentication, BaseAPIIntegration):
    """
    API integration for Mississippi (MS) public records.
    ...
    def __init__(self, jurisdiction_id: int, config: Dict[str, Any] = None):
        """
        Initialize the Mississippi API integration.
    ...
    def authenticate(self) -> bool:
        """
        Authenticate with the Mississippi API.
    ...
    def map_api_data_to_standard_format(
        ...
        """
        Map Mississippi-specific API data to standard DataGod format.
...
def get_ms_api(jurisdiction_id: int, config: Dict[str, Any] = None) -> MississippiAPI:
    """
    Get a configured Mississippi API instance.
    ...
    Returns:
        Configured MississippiAPI instance
    """
    return MississippiAPI(jurisdiction_id, config)
