...
SCRAPER_RATE_LIMIT = float(os.getenv("SCRAPER_RATE_LIMIT", "1.0"))  # requests per second
...
# Proxy Configuration
PROXY_LIST_FILE = os.getenv("PROXY_LIST_FILE", str(PROJECT_ROOT / "config" / "proxies.txt"))

# Data Deduplication Configuration
DEDUPLICATION_SIMILARITY_THRESHOLD = float(os.getenv("DEDUPLICATION_SIMILARITY_THRESHOLD", "0.8"))
...
NOTIFICATION_SLACK_ENABLED = os.getenv("NOTIFICATION_SLACK_ENABLED", "false").lower() == "true"
