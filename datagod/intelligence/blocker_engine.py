...
class BlockerUnlockerEngine:
    ...
    def _initialize_catalog(self):
        ...
        self.BLOCKER_CATALOG["irs_tax_lien"] = BlockerType(
            ...
            default_fix_options=[
                ...
                {
                    "action": "apply_for_discharge",
                    "timeframe": "medium_term",
                    "cost_multiplier": 0.1,
                },
                {
                    "action": "subordination_request",
                    "timeframe": "medium_term",
        ...
        self.BLOCKER_CATALOG["lis_pendens"] = BlockerType(
            ...
            default_fix_options=[
                ...
                {
                    "action": "purchase_pending_litigation",
                    "timeframe": "short_term",
                    "cost_multiplier": 0.3,
                },
            ],
        ...
        self.BLOCKER_CATALOG["title_defect"] = BlockerType(
            ...
            default_fix_options=[
                {
                    "action": "quiet_title_action",
                    "timeframe": "long_term",
                    "cost_multiplier": 1.5,
                },
                {
                    "action": "corrective_deed",
                    "timeframe": "medium_term",
                    "cost_multiplier": 0.3,
                },
                {
                    "action": "affidavit_correction",
                    "timeframe": "short_term",
                    "cost_multiplier": 0.1,
                },
            ],
        ...
        self.BLOCKER_CATALOG["unreleased_mortgage"] = BlockerType(
            ...
            default_fix_options=[
                {
                    "action": "obtain_satisfaction",
                    "timeframe": "short_term",
                    "cost_multiplier": 0.05,
                },
                {
                    "action": "affidavit_of_payment",
                    "timeframe": "quick_win",
        ...
        self.BLOCKER_CATALOG["foreclosure_pending"] = BlockerType(
            ...
            default_fix_options=[
                {
                    "action": "purchase_from_lender",
                    "timeframe": "medium_term",
                    "cost_multiplier": 0.7,
                },
                {
                    "action": "purchase_at_auction",
                    "timeframe": "short_term",
                    "cost_multiplier": 0.6,
                },
                {
                    "action": "short_sale_negotiation",
                    "timeframe": "medium_term",
                    "cost_multiplier": 0.8,
                },
            ],
        ...
        self.BLOCKER_CATALOG["bankruptcy_stay"] = BlockerType(
            ...
            default_fix_options=[
                {
                    "action": "wait_for_discharge",
                    "timeframe": "long_term",
                    "cost_multiplier": 0.0,
                },
                {
                    "action": "purchase_from_trustee",
                    "timeframe": "medium_term",
                    "cost_multiplier": 0.8,
                },
                {
                    "action": "relief_from_stay_motion",
                    "timeframe": "short_term",
                    "cost_multiplier": 0.1,
                },
            ],
        ...
        self.BLOCKER_CATALOG["probate_required"] = BlockerType(
            ...
            default_fix_options=[
                {
                    "action": "wait_for_probate",
                    "timeframe": "long_term",
                    "cost_multiplier": 0.0,
                },
                {
                    "action": "purchase_from_estate",
                    "timeframe": "medium_term",
                    "cost_multiplier": 0.9,
                },
            ],
        ...
        self.BLOCKER_CATALOG["code_violation"] = BlockerType(
            ...
            default_fix_options=[
                {
                    "action": "cure_violations",
                    "timeframe": "medium_term",
                    "cost_multiplier": 1.5,
                },
                {
                    "action": "pay_fines_only",
                    "timeframe": "quick_win",
                    "cost_multiplier": 1.0,
                },
            ],
        ...
        self.BLOCKER_CATALOG["unpermitted_work"] = BlockerType(
            ...
            default_fix_options=[
                {
                    "action": "obtain_retroactive_permits",
                    "timeframe": "medium_term",
                    "cost_multiplier": 0.2,
                },
                {
                    "action": "remove_unpermitted_work",
                    "timeframe": "medium_term",
                    "cost_multiplier": 0.5,
                },
                {
                    "action": "disclose_and_discount",
                    "timeframe": "quick_win",
                    "cost_multiplier": 0.0,
                },
            ],
    ...
    def _analyze_title(self, all_data: Dict[str, Any]) -> List[Blocker]:
        ...
        if title_data.get("lis_pendens"):
            ...
            if blocker_type:
                blockers.append(
                    self._create_blocker_from_type(
                        blocker_type, title_data.get("lis_pendens"), "title_search"
                    )
                )
        ...
        if title_data.get("defects"):
            ...
            if blocker_type:
                for defect in title_data.get("defects", []):
                    blockers.append(
                        self._create_blocker_from_type(
                            blocker_type, defect, "title_search"
                        )
                    )
    ...
    def _analyze_legal(self, all_data: Dict[str, Any]) -> List[Blocker]:
        ...
        if legal_data.get("foreclosure") or property_data.get("foreclosure_status"):
            ...
            if blocker_type:
                blockers.append(
                    self._create_blocker_from_type(
                        blocker_type, legal_data.get("foreclosure", {}), "court_records"
                    )
                )
        ...
        if legal_data.get("bankruptcy"):
            ...
            if blocker_type:
                blockers.append(
                    self._create_blocker_from_type(
                        blocker_type, legal_data.get("bankruptcy"), "bankruptcy_court"
                    )
                )
    ...
    def _create_blocker_from_type(
        self, blocker_type: BlockerType, data: Dict[str, Any], source: str
    ) -> Blocker:
    ...
    def _generate_fix_options(
        self, blocker_type: BlockerType, data: Dict[str, Any]
    ) -> List[FixOption]:
        ...
        for default_fix in blocker_type.default_fix_options:
            ...
            timeframe = (
                FixTimeframe(timeframe_str)
                if timeframe_str in [e.value for e in FixTimeframe]
                else FixTimeframe.UNKNOWN
            )
            ...
            option = FixOption(
                ...
                confidence=(
                    0.7
                    if timeframe in [FixTimeframe.IMMEDIATE, FixTimeframe.QUICK_WIN]
                    else 0.5
                ),
                requires=[],
    ...
    def _calculate_priority(self, blocker: Blocker) -> float:
        ...
        if blocker.fix_options:
            quick_fixes = [
                f
                for f in blocker.fix_options
                if f.timeframe in [FixTimeframe.IMMEDIATE, FixTimeframe.QUICK_WIN]
            ]
            if quick_fixes:
                base_score += 0.1
    ...
    def generate_fix_list(
        self, blockers: List[Blocker], timeframe: Optional[FixTimeframe] = None
        ...
        for blocker in blockers:
            for fix in blocker.fix_options:
                fix_entry = {
                    ...
                    "cost_range": (
                        f"${fix.estimated_cost_low:,.0f} - ${fix.estimated_cost_high:,.0f}"
                        if fix.estimated_cost_low
                        else "Unknown"
                    ),
