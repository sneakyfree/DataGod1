...
class ScenarioUniverseBuilder:
    ...
    def _evaluate_scenario(
        self, scenario_type: ScenarioType, all_data: Dict[str, Any]
        ...
        confidence_score, confidence_level, ci_lower, ci_upper = (
        ...
        actions = self._generate_recommended_actions(
            scenario_type, confidence_level, missing_data
        )
    ...
    def get_scenario_summary(self, results: List[ScenarioResult]) -> Dict[str, Any]:
        ...
        top_opportunities = [
            r
            for r in results
            if r.category == ScenarioCategory.OPPORTUNITY and r.confidence_score >= 0.4
        ]
        top_risks = [
            r
            for r in results
            if r.category == ScenarioCategory.RISK and r.confidence_score >= 0.4
        ]
