...
class TestAnomalyDetector:
    ...
    def test_record_anomaly_detection(self, detector, sample_records):
        ...
        results = detector.detect_record_anomalies(
            sample_records,
            value_field='value'
        )
    ...
    def test_anomaly_types(self, detector, sample_data):
        ...
        valid_types = [AnomalyType.SPIKE, AnomalyType.DROP, AnomalyType.TREND_CHANGE, 
                      AnomalyType.SEASONALITY_BREAK, AnomalyType.OUTLIER]
