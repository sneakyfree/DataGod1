...
class TestDuplicateGroup:
    ...
    def test_create_duplicate_group(self):
        ...
        group = DuplicateGroup(group_id="group123", canonical_record=canonical)
    ...
    def test_duplicate_group_to_dict(self):
        ...
        group = DuplicateGroup(
            group_id="group123", canonical_record={"id": "1"}, confidence_score=0.95
        )
    ...
    def test_duplicate_group_default_merge_strategy(self):
        ...
        group = DuplicateGroup(group_id="group123", canonical_record={"id": "1"})
...
class TestDeduplicationMetrics:
    ...
    def test_deduplication_metrics_to_dict(self):
        ...
        metrics = DeduplicationMetrics(total_records_processed=100, duplicates_found=10)
    ...
    def test_deduplication_rate_zero_records(self):
        ...
        metrics = DeduplicationMetrics(total_records_processed=0, duplicates_found=0)
        result = metrics.to_dict()
...
class TestStreetAbbreviations:
    ...
    def test_common_street_types(self):
        ...
        for input_addr, expected in test_cases:
            ...
            assert (
                expected in result
            ), f"Expected '{expected}' in normalized '{input_addr}'"
