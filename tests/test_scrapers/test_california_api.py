...
class TestCaliforniaCountyAPIStructure:
    ...
    def test_california_county_api_inherits_base(self):
        ...
        from datagod.scrapers.california_api import CaliforniaCountyAPI, BaseAPIIntegration
...
class TestCaliforniaCountyAPIConfig:
    ...
    def test_la_has_property_search(self):
        ...
        from datagod.scrapers.california_api import CaliforniaCountyAPI
        assert 'property_search' in CaliforniaCountyAPI.COUNTY_APIS['los-angeles']['features']

    def test_la_has_deed_records(self):
        """Test that LA County has deed_records feature"""
        from datagod.scrapers.california_api import CaliforniaCountyAPI
        assert 'deed_records' in CaliforniaCountyAPI.COUNTY_APIS['los-angeles']['features']

    def test_la_has_mortgage_records(self):
        """Test that LA County has mortgage_records feature"""
        from datagod.scrapers.california_api import CaliforniaCountyAPI
        assert 'mortgage_records' in CaliforniaCountyAPI.COUNTY_APIS['los-angeles']['features']

    def test_la_has_assessor_maps(self):
        """Test that LA County has assessor_maps feature"""
        from datagod.scrapers.california_api import CaliforniaCountyAPI
        assert 'assessor_maps' in CaliforniaCountyAPI.COUNTY_APIS['los-angeles']['features']
...
class TestLosAngelesCountyAPI:
    ...
    def test_la_county_api_inherits_california(self):
        ...
        from datagod.scrapers.california_api import LosAngelesCountyAPI, CaliforniaCountyAPI
...
class TestSanDiegoCountyAPI:
    ...
    def test_san_diego_county_api_inherits_california(self):
        ...
        from datagod.scrapers.california_api import SanDiegoCountyAPI, CaliforniaCountyAPI
...
class TestSanFranciscoCountyAPI:
    ...
    def test_sf_county_api_inherits_california(self):
        ...
        from datagod.scrapers.california_api import SanFranciscoCountyAPI, CaliforniaCountyAPI
...
class TestSantaClaraCountyAPI:
    ...
    def test_santa_clara_county_api_inherits_california(self):
        ...
        from datagod.scrapers.california_api import SantaClaraCountyAPI, CaliforniaCountyAPI
...
class TestCaliforniaSecretaryOfStateAPI:
    ...
    def test_sos_api_inherits_base(self):
        ...
        from datagod.scrapers.california_api import CaliforniaSecretaryOfStateAPI, BaseAPIIntegration
    ...
    def test_sos_map_business_to_standard_exists(self):
        ...
        from datagod.scrapers.california_api import CaliforniaSecretaryOfStateAPI
        assert hasattr(CaliforniaSecretaryOfStateAPI, '_map_business_to_standard_format')
...
class TestCaliforniaCountyAPIWithMocks:
    ...
    def mock_api(self):
        ...
        with patch('datagod.scrapers.california_api.BaseAPIIntegration.__init__', return_value=None):
            from datagod.scrapers.california_api import CaliforniaCountyAPI
            ...
            api.available_features = ['property_search', 'deed_records', 'mortgage_records', 'tax_info', 'assessor_maps']
...
class TestCaliforniaCountyAPICountyCount:
    ...
    def test_major_california_counties_covered(self):
        ...
        from datagod.scrapers.california_api import CaliforniaCountyAPI
        major_counties = ['los-angeles', 'san-diego', 'orange', 'santa-clara', 'san-francisco']

        for county in major_counties:
            assert county in CaliforniaCountyAPI.COUNTY_APIS, f"Missing major county: {county}"

    def test_bay_area_counties_covered(self):
        """Test that Bay Area counties are covered"""
        from datagod.scrapers.california_api import CaliforniaCountyAPI
        bay_area_counties = ['alameda', 'santa-clara', 'san-francisco', 'san-mateo', 'contra-costa']

        for county in bay_area_counties:
            assert county in CaliforniaCountyAPI.COUNTY_APIS, f"Missing Bay Area county: {county}"
