...
class TestJurisdictionResearcher:
    ...
    def test_researcher_has_methods(self):
        ...
        assert hasattr(researcher, 'research_jurisdiction') or hasattr(researcher, 'get_state_list')
...
class TestScraperGenerator:
    ...
    def test_generator_has_methods(self):
        ...
        assert hasattr(generator, 'generate_scraper') or hasattr(generator, 'create_scraper')
