...
class TestNewsCategoryEnum:
    ...
    def test_all_categories_defined(self):
        ...
        from datagod.scrapers.categories.news_api import NewsCategory
        expected = ['BUSINESS', 'TECHNOLOGY', 'POLITICS', 'REAL_ESTATE',
                   'LEGAL', 'FINANCE', 'LOCAL', 'CRIME', 'GOVERNMENT',
                   'GENERAL', 'UNKNOWN']
        for cat in expected:
...
class TestNewsSourceTypeEnum:
    ...
    def test_all_source_types_defined(self):
        ...
        from datagod.scrapers.categories.news_api import NewsSourceType
        expected = ['MAJOR_OUTLET', 'LOCAL_NEWS', 'WIRE_SERVICE',
                   'PRESS_RELEASE', 'BLOG', 'TRADE_PUBLICATION',
                   'GOVERNMENT', 'UNKNOWN']
        for st in expected:
...
class TestNewsSource:
    ...
    def test_news_source_to_dict(self):
        ...
        from datagod.scrapers.categories.news_api import NewsSource, NewsCategory, NewsSourceType
        source = NewsSource(
            source_id='test123',
            name='Test News',
    ...
    def test_classify_category_business(self):
        ...
        class ConcreteScraper(NewsAPIScraper):
            def search_articles(self, search):
                return []
            def get_top_headlines(self, country="us", category=None, sources=None, keywords=None):
                return []
...
class TestLocalNewsAggregator:
    ...
    def test_get_source_state(self):
        ...
        class ConcreteAggregator(LocalNewsAggregator):
            def search_local_news(self, keywords, state, city=None, date_from=None, date_to=None):
                return []
