...
class TestUSPTOScraper:
    ...
    def test_parse_trademark_status(self):
        ...
        assert (
            scraper.parse_trademark_status("Registered") == TrademarkStatus.REGISTERED
        )
        ...
        assert (
            scraper.parse_trademark_status("unknown status") == TrademarkStatus.UNKNOWN
        )
...
class TestSECCompany:
    ...
    def test_sec_company_to_dict(self):
        ...
        company = SECCompany(cik="0000000001", company_name="Test Corp", ticker="TEST")
...
class TestBankBranch:
    ...
    def test_create_bank_branch(self):
        ...
        branch = BankBranch(
            branch_number="001", branch_name="Main Branch", bank_fdic_cert="12345"
        )
...
class TestCensusData:
    ...
    def test_create_census_data(self):
        ...
        data = CensusData(geo_id="01", geo_name="Alabama", geo_type="state")
    ...
    def test_census_data_to_dict(self):
        ...
        data = CensusData(
            geo_id="01", geo_name="Alabama", geo_type="state", total_population=5000000
        )
        result = data.to_dict()
...
class TestHousePriceIndex:
    ...
    def test_create_house_price_index(self):
        ...
        hpi = HousePriceIndex(
            geo_name="California", geo_type="state", period="2023-Q4", index_value=450.5
        )
