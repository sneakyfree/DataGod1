...
class TestGenericStateAPISearch:
    ...
    def test_search_records_all_types(self, mock_validate, mock_request, api_with_mock_request):
    ...
    @patch.object(GenericStateAPI, 'make_request')
    @patch.object(GenericStateAPI, 'validate_response')
    def test_search_records_specific_type(self, mock_validate, mock_request, api_with_mock_request):
    ...
    @patch.object(GenericStateAPI, 'make_request')
    @patch.object(GenericStateAPI, 'validate_response')
    def test_search_records_with_county_kwarg(self, mock_validate, mock_request, api_with_mock_request):
    ...
    @patch.object(GenericStateAPI, 'make_request')
    @patch.object(GenericStateAPI, 'validate_response')
    def test_search_endpoint_property(self, mock_validate, mock_request, api_with_mock_request):
        """Test property search endpoint"""
        mock_response = Mock()
        mock_request.return_value = mock_response
        mock_validate.return_value = {
            'results': [
                {'id': '1', 'owner_name': 'Smith', 'address': '123 Main St'}
            ]
        }
    ...
    @patch.object(GenericStateAPI, 'make_request')
    @patch.object(GenericStateAPI, 'validate_response')
    def test_search_endpoint_deed(self, mock_validate, mock_request, api_with_mock_request):
        """Test deed search endpoint"""
        mock_response = Mock()
        mock_request.return_value = mock_response
        mock_validate.return_value = {
            'results': [
                {'id': '1', 'party_name': 'Smith', 'doc_number': 'D12345'}
            ]
        }
    ...
    @patch.object(GenericStateAPI, 'make_request')
    @patch.object(GenericStateAPI, 'validate_response')
    def test_search_endpoint_lien(self, mock_validate, mock_request, api_with_mock_request):
        """Test lien search endpoint"""
        mock_response = Mock()
        mock_request.return_value = mock_response
        mock_validate.return_value = {
            'results': [
                {'id': '1', 'debtor_name': 'Smith', 'amount': 50000}
            ]
        }
    ...
    @patch.object(GenericStateAPI, 'make_request')
    def test_search_endpoint_unexpected_error(self, mock_request, api_with_mock_request):
...
class TestGenericStateAPIRecordDetails:
    ...
    @patch.object(GenericStateAPI, 'make_request')
    @patch.object(GenericStateAPI, 'validate_response')
    def test_get_record_details_success(self, mock_validate, mock_request, api_with_county):
...
class TestGenericStateAPIResponseHandling:
    ...
    @patch.object(GenericStateAPI, 'make_request')
    @patch.object(GenericStateAPI, 'validate_response')
    def test_handle_single_record_response(self, mock_validate, mock_request, api_with_county):
