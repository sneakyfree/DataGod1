...
class TestDisciplinaryAction:
    ...
    def test_to_dict(self):
        ...
        action = DisciplinaryAction(
            action_date=date(2024, 1, 15), action_type="Suspension", fine_amount=500.0
        )
...
class TestEmployer:
    ...
    def test_employer_to_dict(self):
        ...
        employer = Employer(name="XYZ Bank", city="Austin")
...
class TestStateLicenseBoardScraper:
    ...
    def test_search_licenses_returns_list(self):
        ...
        scraper = StateLicenseBoardScraper(
            state_code="TX", license_type=LicenseType.REAL_ESTATE_AGENT
        )
...
class TestConvenienceFunctions:
    ...
    def test_search_professional_licenses_returns_list(self):
        ...
        result = search_professional_licenses(name="John Doe", states=["TX", "CA"])
