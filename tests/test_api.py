...
class TestAPIEndpoints:
    ...
    def test_records_endpoint_structure(self):
        ...
        mock_response = {"items": [], "total": 0, "page": 1, "page_size": 50}
    ...
    def test_search_endpoint_structure(self):
        ...
        mock_response = {"results": [], "total": 0, "filters_applied": {}}
...
class TestAuthEndpoints:
    ...
    def test_token_endpoint_invalid(self, client):
        ...
        response = client.post(
            "/token", data={"username": "invalid_user", "password": "wrong_password"}
        )
...
class TestProtectedEndpoints:
    ...
    def test_create_jurisdiction_unauthorized(self, client):
        ...
        response = client.post(
            "/jurisdictions", json={"name": "Test County", "state": "TX"}
        )
...
class TestExportEndpoint:
    ...
    def test_export_json_format(self, client):
        ...
        response = client.post(
            "/export",
            json={"record_ids": [], "format": "json", "include_metadata": True},
        )
        # May require auth or return 200
        assert response.status_code in [200, 401]
    ...
    def test_export_csv_format(self, client):
        ...
        response = client.post(
            "/export",
            json={"record_ids": [], "format": "csv", "include_metadata": False},
        )
        # May require auth or return 200
        assert response.status_code in [200, 401]
