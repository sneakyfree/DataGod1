...
class TestWashingtonCountyAPI:
    ...
    def test_initialization(self):
        ...
        config = {"jurisdiction_name": "King County", "requests_per_minute": 30}
    ...
    def test_property_mapping(self):
        ...
        api = WashingtonCountyAPI(
            jurisdiction_id=1, config={"jurisdiction_name": "King County"}
        )
...
class TestColoradoCountyAPI:
    ...
    def test_initialization(self):
        ...
        config = {"jurisdiction_name": "Denver County", "requests_per_minute": 30}
    ...
    def test_property_mapping(self):
        ...
        api = ColoradoCountyAPI(
            jurisdiction_id=1, config={"jurisdiction_name": "Denver County"}
        )
...
class TestNorthCarolinaCountyAPI:
    ...
    def test_initialization(self):
        ...
        config = {"jurisdiction_name": "Wake County", "requests_per_minute": 30}
    ...
    def test_property_mapping(self):
        ...
        api = NorthCarolinaCountyAPI(
            jurisdiction_id=1, config={"jurisdiction_name": "Wake County"}
        )
...
class TestVirginiaCountyAPI:
    ...
    def test_initialization(self):
        ...
        config = {"jurisdiction_name": "Fairfax County", "requests_per_minute": 30}
    ...
    def test_property_mapping(self):
        ...
        api = VirginiaCountyAPI(
            jurisdiction_id=1, config={"jurisdiction_name": "Fairfax County"}
        )
...
class TestNewJerseyCountyAPI:
    ...
    def test_initialization(self):
        ...
        config = {"jurisdiction_name": "Bergen County", "requests_per_minute": 30}
    ...
    def test_block_lot_mapping(self):
        ...
        api = NewJerseyCountyAPI(
            jurisdiction_id=1, config={"jurisdiction_name": "Bergen County"}
        )
...
class TestScraperRegistry:
    ...
    def test_total_supported_counties(self):
        ...
        from datagod.scrapers import SUPPORTED_COUNTIES, TOTAL_SUPPORTED_COUNTIES
