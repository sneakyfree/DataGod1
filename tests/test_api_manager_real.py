...
class TestCredentialsManagement:
    ...
    def test_add_credentials_new(self):
        ...
        credentials[api_name] = {**new_creds, "updated_at": datetime.now().isoformat()}
    ...
    def test_add_credentials_update(self):
        ...
        credentials = {"existing_api": {"api_key": "old_key"}}
    ...
    def test_get_credentials_exists(self):
        ...
        credentials = {"test_api": {"api_key": "test123"}}
...
class TestIntegrationValidation:
    ...
    def test_is_integration_valid_no_expiry(self):
        ...
        is_valid = (
            not hasattr(integration, "token_expires_at")
            or integration.token_expires_at is None
        )
...
class TestUsageTracking:
    ...
    def test_track_api_usage_existing_api(self):
        ...
        usage_stats = {
            "api_usage": {"existing_api": {"requests": 10, "results": 50, "cost": 5.0}},
            "total_requests": 10,
            "total_cost": 5.0,
        }
...
class TestCostReport:
    ...
    def test_generate_cost_report_no_usage(self):
        ...
        usage_stats = {"total_cost": 0.0, "total_requests": 0, "api_usage": {}}
    ...
    def test_generate_cost_report_with_usage(self):
        ...
        usage_stats = {
            "total_cost": 10.0,
            "total_requests": 100,
            "api_usage": {"test_api": {"requests": 100, "results": 500, "cost": 10.0}},
        }
    ...
    def test_cleanup_expired_integrations(self):
        ...
        for cache_key, integration in active_integrations.items():
            if (
                ...
                if datetime.now() >= integration.token_expires_at - timedelta(
                    minutes=5
                ):
...
class TestAPIRegistry:
    ...
    def test_get_api_info_exists(self):
        ...
        api_registry = {
            "test_api": type(
                "TestAPI", (), {"__name__": "TestAPI", "__module__": "test.module"}
            )
        }
...
class TestAPIMetrics:
    ...
    def test_get_api_metrics_structure(self):
        ...
        usage_stats = {"total_requests": 100, "total_cost": 10.0, "api_usage": {}}

        metrics = {"overall": usage_stats.copy(), "integrations": {}}
