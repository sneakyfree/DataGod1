...
class TestDeduplicationService:
    ...
    def test_calculate_similarity_exact_match(self, service, duplicate_records):
        ...
        similarity, match_fields = service._calculate_similarity(
            duplicate_records[0],
            duplicate_records[0]  # Same record
        )
    ...
    def test_calculate_similarity_low_match(self, service, duplicate_records, non_duplicate_records):
    ...
    def test_find_duplicates_no_matches(self, service, duplicate_records, non_duplicate_records):
    ...
    def test_find_duplicates_skips_same_record(self, service, duplicate_records):
        ...
        groups = service.find_duplicates(
            duplicate_records[0],
            duplicate_records  # Includes the same record
        )
    ...
    def test_find_all_duplicates(self, service, duplicate_records, non_duplicate_records):
    ...
    def test_select_most_complete(self, service):
        ...
        records = [
            ...
            {"record_id": "complete", "field1": "value1", "field2": "value2", "field3": "value3"}
        ]
    ...
    def test_merge_records(self, service):
        ...
        records = [
            ...
            {"record_id": "rec2", "field_a": None, "field_b": "value_b", "field_c": "value_c"}
        ]
...
class TestDeduplicateRecordsFunction:
    ...
    def mixed_records(self):
        ...
        return [
            {"record_id": "dup_1", "document_number": "2024-001", "grantor": "John Smith"},
            {"record_id": "dup_2", "document_number": "2024-001", "grantor": "John A Smith"},
            {"record_id": "unique_1", "document_number": "2024-002", "grantor": "Mary Johnson"},
            {"record_id": "unique_2", "document_number": "2024-003", "grantor": "Bob Wilson"},
        ]
    ...
    def test_deduplicate_records_with_threshold(self, mixed_records):
        ...
        deduplicated_low, stats_low = deduplicate_records(
            mixed_records,
            threshold=0.50
        )
